...
function QlobberFSQ(options)
{
    ...
    function create_multicast_receiver()
    {
        ...
        ths._multicast_receiver.on('message', function (relpath)
        {
        ...
        ths._multicast_receiver.on('error', ths._error);
    }
    ...
    function create_multicast_sender()
    {
        ...
        ths._multicast_sender.on('error', ths._error);
    }
    ...
    function start_notifiers(err)
    {
        ...
        {
            return create_multicast_sender();
        }
    ...
    function rename_and_update()
    {
        ths._fs.rename(staging_fname, msg_fname, function (err)
        {
            ...
            register(update_stream, function ()
            {
                ...
                {
                    return ths._multicast_sender.send(
                        bucket_fmt + path.sep + fname,
                        ths._multicast_port,
